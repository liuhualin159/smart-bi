<template>
  <div class="app-container aether-list-page">
    <el-row :gutter="20" class="user-list-layout-row">
      <splitpanes :horizontal="appStore.device === 'mobile'" class="default-theme user-list-splitpanes">
        <!--部门数据-->
        <pane size="16">
          <el-col :span="24" class="user-pane-content user-pane-content--left">
            <div class="head-container aether-side-panel user-dept-filter-panel">
              <el-input v-model="deptName" placeholder="请输入部门名称" clearable prefix-icon="Search" style="margin-bottom: 20px" />
            </div>
            <div class="head-container aether-side-panel user-dept-tree-panel">
        ...
        <!--用户数据-->
        <pane size="84">
          <el-col :span="24" class="user-pane-content user-pane-content--right">
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange" class="aether-table user-list-table">
...
<style scoped>
.user-list-layout-row {
  height: 100%;
  min-height: 0;
}

.user-list-splitpanes {
  height: 100%;
  width: 100%;
}
...
.user-pane-content--left {
  display: flex;
  flex-direction: column;
  min-height: 0;
}

.user-dept-filter-panel {
  flex: 0 0 auto;
}

.user-dept-tree-panel {
  flex: 1;
  min-height: 0;
  overflow: auto;
}

.user-dept-filter-panel :deep(.el-input__wrapper) {
  background: rgba(255, 255, 255, 0.02);
  border: 1px solid rgba(58, 73, 75, 0.35);
  box-shadow: none;
}

.user-dept-filter-panel :deep(.el-input__wrapper.is-focus) {
  border-color: rgba(0, 242, 255, 0.7);
  box-shadow: 0 0 0 1px rgba(0, 242, 255, 0.2);
}

.user-dept-tree-panel :deep(.el-tree) {
  background: transparent;
  color: rgba(255, 255, 255, 0.92);
}

.user-dept-tree-panel :deep(.el-tree-node__content) {
  height: 34px;
  border-radius: 6px;
...
.user-dept-tree-panel :deep(.el-tree-node__content:hover) {
  background: rgba(255, 255, 255, 0.05);
  color: #f3f4f8;
}

.user-dept-tree-panel :deep(.el-tree-node.is-current > .el-tree-node__content) {
  background: rgba(0, 242, 255, 0.12);
  border: 1px solid rgba(0, 242, 255, 0.35);
  color: #00f2ff;
}

.user-dept-tree-panel :deep(.el-tree-node:focus > .el-tree-node__content) {
  background: rgba(255, 255, 255, 0.04);
}

.user-dept-tree-panel :deep(.el-tree-node__expand-icon) {
